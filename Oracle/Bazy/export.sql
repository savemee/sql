--------------------------------------------------------
--  File created - poniedzia³ek-maj-05-2014   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TRG_REGION
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."TRG_REGION" before insert on Regions
for each row
begin
select region_seq.nextval into :new.region_id from dual;
:new.region_id:=initcap(:new.region_id);
end;
/
ALTER TRIGGER "HR"."TRG_REGION" ENABLE;
